...
class UI(tkinter.Frame):
    def __init__(self, master, im, value=128):
        ...
        self.imageData[10][10][1] = 255; #turn pixel at 10, 10's green value to 255, green pixel
        self.imageData[20][20][1] = 255;
        print(self.imageData)
        self.backdrop = ImageTk.PhotoImage(Image.fromarray(self.imageData, 'RGB'))
